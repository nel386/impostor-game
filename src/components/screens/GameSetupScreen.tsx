...
import PlayerNameInput from '../ui/PlayerNameInput'; // NUEVO
...
export default function GameSetupScreen() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-400 to-orange-500 flex items-center justify-center p-6">
      <div className="w-full max-w-2xl bg-white rounded-2xl shadow-2xl p-8 space-y-6 max-h-screen overflow-y-auto">
        {/* Header */}
          ...
          >
            <span
              className={`
                ...
                ${showHint ? 'translate-x-6' : 'translate-x-0'}
              `}
            />
          </button>
        </div>
